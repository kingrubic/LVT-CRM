...
export default defineSchema({
  ...
  officeDocuments: defineTable({
    ...
    .index("by_department", ["departmentId"]),
  /**
   * Department-level work generated by an approved official document.
   * Personal tasks are children of this row.
   */
  workItems: defineTable({
    ...
    .index("by_active_deadline", ["active", "deadline"]),
  /**
   * Personal work items assigned by a level 2/3 department lead to one or
   * more lower-level colleagues in the same department.
   */
